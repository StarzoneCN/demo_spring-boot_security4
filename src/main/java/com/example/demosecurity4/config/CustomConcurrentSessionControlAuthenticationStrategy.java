...
import com.example.demosecurity4.util.WebUtils;
 ...
 * @date: Create in 2019/1/11 14:03
 * @modefied: 2019/1/11 16:03 尝试失败
 */
public class CustomConcurrentSessionControlAuthenticationStrategy implements
        MessageSourceAware, SessionAuthenticationStrategy {

    protected MessageSourceAccessor messages = SpringSecurityMessageSource.getAccessor();
    @Autowired(required = true) private SessionRegistry sessionRegistry;
    ...
    protected void allowableSessionsExceeded(List<SessionInformation> sessions,
        ...
        applicationContext.publishEvent(new PassiveOfflineApplicationEvent(leastRecentlyUsed){{
            this.setMsgObject(WebUtils.getSession());
        }});
