...
INSERT INTO `spring_security_test`.`group` (`group_name`) VALUES ('普通用户');
INSERT INTO `spring_security_test`.`group_user` (`group_id`, `user_id`) VALUES ('1', '1');
INSERT INTO `spring_security_test`.`group_user` (`group_id`, `user_id`) VALUES ('2', '2');
...
INSERT INTO `spring_security_test`.`group_authority` (`group_id`, `authority_id`) VALUES ('2', '2');
